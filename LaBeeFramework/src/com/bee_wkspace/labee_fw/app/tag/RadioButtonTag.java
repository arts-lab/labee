 ...
 *
 * $Id: RadioButtonTag.java 554 2016-08-12 21:19:00Z pjmember $
 */
public class RadioButtonTag extends TagSupport implements TryCatchFinally {

	private static final long serialVersionUID = 3160643087827184344L;
	...
	public int doStartTag() throws JspException {
		try {
			pageContext.getOut().print(makeRadioButton());
		} catch (IOException e) {
	...
	private String makeRadioButton() {
